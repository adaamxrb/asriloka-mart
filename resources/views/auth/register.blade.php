        ...
        <div class="section-store-auth" data-aos="fade-up">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <h2>
                            Memulai pembelian dan transaksi<br />
                            dengan cara terbaru
                        </h2>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label" for="openStoreTrue">Iya</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input class="custom-control-input" type="radio" name="is_store_open"
                                        id="openStoreFalse" v-model="is_store_open" :value="false" />
                                    <label makasih class="custom-control-label" for="openStoreFalse">Lain Kali</label>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-success btn-block mt-4"
                                :class="{ 'disabled': this.email_unavailable }">
                                Daftar
                            </button>
